...
const workflowSections = [
  ...
  },
  {
    id: "design",
    title: "Design",
    description: "Beautiful and responsive design system",
    bgColor: "bg-white dark:bg-[#0B1120]",
    metrics: [
      { label: "Mobile First", value: "Yes" },
      { label: "Tailwind CSS", value: "3.4" },
  ...
  },
  {
    ...
    bgColor: "bg-slate-50 dark:bg-[#0B1120]",
    metrics: [
      { label: "Next.js", value: "15.1" },
      { label: "React", value: "19" },
      { label: "Bundle Size", value: "Small" }
    ]
  },
  {
    id: "pricing",
...
const featureCards = [
  ...
  {
    title: "Animations",
    description: "Smooth Framer Motion animations",
          ...
          <div className="relative pt-20 pb-16 sm:pb-24">
            ...
            <div className="text-center">
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-slate-900 dark:text-white">
                <span className="block">Next.js UI Template</span>
                <span className="block text-primary dark:text-primary-light">Clean & Modern</span>
              </h1>
              <p className="mt-6 max-w-2xl mx-auto text-lg text-slate-600 dark:text-slate-300">
                Beautiful UI components with dark mode and smooth animations.
              </p>
              ...
              <div className="relative">
                <pre className="relative rounded-xl bg-slate-900 p-8 shadow-2xl">
                  <code className="text-sm sm:text-base text-slate-100">
                    <TypewriterEffect text={`// 🚀 Modern UI Template
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative bg-white dark:bg-neutral-dark rounded-xl shadow-xl p-12 border border-slate-200 dark:border-slate-700">
            <div className="text-center">
              ...
              <p className="mt-4 text-lg text-slate-600 dark:text-slate-300">
                Start building with our beautiful UI template today
              </p>
              ...
              <div className="mt-10 flex gap-4 justify-center">
                ...
                <motion.button
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  onClick={() => window.open('https://github.com/gitmvp-com/nextjs-ui-template-mvp', '_blank')}
                  className="px-8 py-3 bg-white dark:bg-neutral-dark hover:bg-slate-50 dark:hover:bg-neutral-darker text-primary dark:text-primary-light border-2 border-primary dark:border-primary-light rounded-lg shadow-lg hover:shadow-xl transition-all"
                >
                  View on GitHub
                </motion.button>
